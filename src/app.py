...
app.layout = html.Div([
    html.H1('Qualification Level Distribution'),
    html.Div([
        dcc.Graph(id='pie-chart-2011'),
        dcc.Graph(id='pie-chart-2021')
    ]),
...
def update_pie_chart_2011(_):
    #get total qualification counts for each level
    qualification_counts_2011 = merged_df['2021_Observation'].groupby(merged_df['highest_qualification_level']).sum()
    ...
    pie_chart_2011.update_layout(title_text='2021 Highest Qualification Level in percentages')
    pie_chart_2011.update_traces(sort=False, legendgroup='group')
